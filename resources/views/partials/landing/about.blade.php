    ...
    <div class="row">
      <div class="col-lg-6 pl-3">
        <article class="about__item about__item--mision">
            <div class="media">
              <img class="mr-3" src="./images/meeting.svg" alt="Misión" class="about__img">
      ...
      <div class="col-lg-6">
        <article class="about__item about__item--vision">
          <div class="media">
            <img class="mr-3" src="./images/target.svg" alt="Visión" class="about__img">
            <div class="media-body">
              <h5 class="mt-0">Visión</h5>
              <p>
                Ser emblemático en la gestión de los recursos humanos de la empresa AVCA de forma transparente y eficiente.
              </p>              
            </div>
          </div>
        </article>
      ...
      <div class="col-12 mt-5">          
        <div class="row no-gutters">
          <div class="col-lg-6">
             <article class="about__item about__item--mision">
              <div class="media">
                <img class="mr-3" src="./images/objetives.svg" alt="Objetives" class="about__img">
                <div class="media-body">
