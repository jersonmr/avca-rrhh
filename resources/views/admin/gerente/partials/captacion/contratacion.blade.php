        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <select name="nivel_academico" id="nivel_academico" class="form-control" @change="obtenerProfesiones" v-model="nivel_academico">
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">                        
                            <input type="text" name="codigo_cuenta" id="codigo_cuenta" v-model="codigo_cuenta" size="4" readonly="readonly" class="input-group-text">
                    </div>
